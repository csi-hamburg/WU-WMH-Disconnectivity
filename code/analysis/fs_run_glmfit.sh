...
cat $BASEDIR/derivatives/GLM/XX.csv | awk -F ' ' '{print 1,$2,$4,log($7),$6}' > $OUTDIR/mRS/X.csv

matlab -nodisplay -nodesktop -r "X=dlmread('$OUTDIR/mRS/X.csv', ' '); save('$OUTDIR/mRS/X.mat','X','-v4'); quit"

echo -e "0 0 0 0 1" > $OUTDIR/mRS/mRS_pos.mat
...
cat $BASEDIR/derivatives/GLM/XX.csv | awk -F ' ' '{print 1,$2,$7,$5,$6,$5*$6}' > $OUTDIR/mRSxTx/X.csv
...
echo -e "0 0 0 0 0 1" > $OUTDIR/mRSxTx/Ix_pos.mat
echo -e "0 0 0 0 0 -1" > $OUTDIR/mRSxTx/Ix_neg.mat
